    ...
    def apply_autofill_listeners(self, browser: QWebEngineView | None = None):
        ...
        (function() {
            function checkAutofill() {
                // Find email inputs - check type, name, id, placeholder, and aria-label
                ...
                emailInputs.forEach(function(input) {
                    if (!input.hasAttribute('data-pybrowser-autofill')) {
                        input.setAttribute('data-pybrowser-autofill', 'true');
            ...
            var observer = new MutationObserver(checkAutofill);
    ...
    def handle_autofill_result(self, result, field_type):
        ...
        if result == 'prompt_email':
            ...
            if reply == QMessageBox.StandardButton.Yes:
                script = f"""
                (function() {{
                    // Try to find the focused email input
