...
DEFAULT_SETTINGS = {
    ...
    "view_style": "none",     # none, bw, invert, contrast, cracked
    # bookmarks (legacy; now stored in separate JSON)
    "bookmarks": [],
    # home page settings
    "home_mode": "engine",           # "engine" or "custom"
    "home_custom_url": "",
...
# -------------------------
# AI Assistant window (separate window, not popup)
# -------------------------
class AIAssistantWindow(QMainWindow):
    def __init__(self, settings: dict, parent=None):
        ...
        self.messages = [
            {"role": "system", "content": "You are PyBrowser's helpful AI assistant."}
        ]
    ...
    def add_message_bubble(self, text: str, role: str):
...
class CustomBrowser(QMainWindow):
    ...
    def detach_tab(self, index: int):
        ...
        # Close this window if no tabs left
    ...
    def move_tab_to_other_window(self, index: int, dest_window: "CustomBrowser", dest_index: int):
        ...
        # Close this window if no tabs left after moving
        if self.tabs.count() == 0:
            self.close()
    ...
    def show_bookmark_dialog(self, initial_title: str, initial_url: str):
        ...
        # Determine button label based on whether fields were changed
        ...
        # Update button text when fields change
