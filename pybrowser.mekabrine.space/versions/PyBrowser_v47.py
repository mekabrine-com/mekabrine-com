...
class AIAssistantWindow(QMainWindow):
    ...
    def start_agent_mode(self, user_request: str):
        ...
        # Create new browser window for the agent with unique profile
        from __main__ import CustomBrowser
        browser_window = CustomBrowser(profile_name=f"PyBrowserAgent_{int(time.time())}")
...
class CustomBrowser(QMainWindow):
    ...
    def __init__(self, profile_name=None):
        ...
        # Create unique profile for each window
        if profile_name is None:
            CustomBrowser._profile_counter += 1
            profile_name = f"PyBrowserProfile_{CustomBrowser._profile_counter}"
