...
DEFAULT_SETTINGS = {
    ...
    # bookmarks (json now stored separately, this is legacy)
    "bookmarks": [],
    # home page settings
...
class BookmarkBar(QWidget):
    ...
    def eventFilter(self, obj, event):
        if isinstance(obj, BookmarkButton):
            # Right-click context menu -> open edit dialog
...
class CustomBrowser(QMainWindow):
    ...
    def enable_javascript_features(self):
        ...
        # Fullscreen support (for YouTube etc.)
